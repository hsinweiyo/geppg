...
if __name__ == '__main__':
    ...
    for i in range(nb_eps):
        ...
        file_path = saving_folder + env_id + '/' + 'reacher-ablative/' + '0.1' + '_' + str(5000) + '_itr.pk'
        gep_memory = dict()
        ...
        nearest_pos = run_testing(target, target_mid, goal, knn, obs, nb_rew, nb_timesteps, env, controller)
